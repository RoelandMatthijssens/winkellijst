  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved household as @household" do
        ...
        post :create, {:household => { "name" => "invalid value" }}, valid_session
        assigns(:household).should be_a_new(Household)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested household" do
        ...
        Household.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => household.to_param, :household => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the household as @household" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Household.any_instance.stub(:save).and_return(false)
        put :update, {:id => household.to_param, :household => { "name" => "invalid value" }}, valid_session
        assigns(:household).should eq(household)
      end
